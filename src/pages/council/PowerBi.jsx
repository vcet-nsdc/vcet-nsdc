...
const PowerBI = () => {
  const powerBiGallery = [
    { type: "image", src: "../img/events/PowerBI/powerbi_img_0.webp" },
    { type: "image", src: "../img/events/PowerBI/powerbi_img_1.webp" },
    { type: "image", src: "../img/events/PowerBI/powerbi_img_2.webp" },
    { type: "image", src: "../img/events/PowerBI/powerbi_img_3.webp" },
    { type: "image", src: "../img/events/PowerBI/powerbi_img_4.webp" },
    { type: "image", src: "../img/events/PowerBI/powerbi_img_5.webp" },
  ];
  return (
    <>
      <main>
